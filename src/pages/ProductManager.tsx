...
export default function ProductManager() {
  ...
  const {
    ...
    defaultValues: {
      ...
      installation_amount_2: undefined,
  ...
  const onSubmit = async (form: ProductInput) => {
    try {
      ...
      const payload = {
        ...
        installation_amount_2: form.installation_amount_2||0,
  ...
  const startEdit = (p: Product) => {
    ...
    reset({
      ...
      installation_amount_2: p.installation_amount_2,
    ...
    <tr className="hover:bg-gray-50 transition-colors">
      ...
      <td className="px-6 py-4 text-sm text-gray-900">
        <div className="space-y-1">
          ...
          <div>Amount 2: ₹{product.installation_amount_2.toLocaleString()}</div>
        </div>
      </td>
      <td className="px-6 py-4">
...
>
  ...
  <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
    ...
    {/* Installation Amount 2 */}
    <div className="space-y-2">
      <label className="block text-sm font-semibold text-gray-700">Installation Amount 2</label>
      <input
        type="number"
        step="0.01"
        placeholder="Enter installation amount 2"
        className="w-full border border-gray-300 rounded-lg px-4 py-3 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors"
        {...register("installation_amount_2")}
      />
    </div>
  </div>
